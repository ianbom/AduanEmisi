...
const StatSection = () => {
    return (
        <section className="relative py-20 overflow-hidden bg-gradient-to-br from-white via-emerald-50 to-emerald-100">
            <div className="absolute rounded-full -top-32 left-1/4 h-96 w-96 bg-green-200/70 blur-3xl"></div>
            <div className="absolute rounded-full -bottom-40 right-1/4 h-96 w-96 bg-emerald-200/30 blur-3xl"></div>
