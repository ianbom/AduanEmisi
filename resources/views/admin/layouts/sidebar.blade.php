            ...
            <div id="mobile-sidebar-panel"
                ...
                <div class="flex flex-col px-6 pb-2 overflow-y-auto bg-white grow gap-y-5">
                    <div class="flex items-center h-16 shrink-0">
                        <img class="w-auto h-8" src="/assets/images/LogoSobatBumi.png" alt="Your Company">
                    </div>
    ...
    <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
        <div class="flex flex-col px-6 overflow-y-auto bg-white border-r border-gray-200 grow gap-y-5">
            <div class="flex items-center h-16 shrink-0">
                <img class="w-auto h-8" src="/assets/images/LogoSobatBumi.png" alt="Your Company">
                <span
                    className="ml-3 bg-gradient-to-r from-emerald-600 to-emerald-800 bg-clip-text text-2xl font-bold text-transparent">
                    SobatBumi
                </span>
            </div>
            <nav class="flex flex-col flex-1">
                <ul role="list" class="flex flex-col flex-1 gap-y-7">
                    <li>
                        <ul role="list" class="-mx-2 space-y-1">
                            <li>
                                ...
                                <a href="#"
                                    class="flex p-2 font-semibold text-indigo-600 rounded-md group gap-x-3 bg-gray-50 text-sm/6">
                                    <svg class="text-indigo-600 size-6 shrink-0" fill="none" viewBox="0 0 24 24"
                    ...
                    <li>
                        <div class="font-semibold text-gray-400 text-xs/6">Sertifikat dan Badges</div>
                        <ul role="list" class="mt-2 -mx-2 space-y-1">
                            <li>
                                <!-- Current: "bg-gray-50 text-indigo-600", Default: "text-gray-700 hover:text-indigo-600 hover:bg-gray-50" -->
                                <a href="#"
