<div>
    ...
    <div id="mobile-sidebar" class="relative z-50 hidden lg:hidden" role="dialog" aria-modal="true">
        <div id="sidebar-backdrop" class="fixed inset-0 transition-opacity duration-300 ease-linear bg-gray-900/80 opacity-0" aria-hidden="true"></div>
        <div class="fixed inset-0 flex">
            <div id="mobile-sidebar-panel" class="relative flex flex-1 w-full max-w-xs mr-16 transition duration-300 ease-in-out transform -translate-x-full">
                ...
                <div class="flex flex-col px-6 pb-4 overflow-y-auto bg-gradient-to-b from-emerald-700 to-emerald-900 grow gap-y-5">
