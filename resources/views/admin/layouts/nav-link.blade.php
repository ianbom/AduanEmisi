        ...
        <li>
            ...
            <ul role="list" class="mt-2 -mx-2 space-y-1">
                ...
                <li>
                    {{-- Map --}}
                    <a href="#"
                        class="flex p-2 font-semibold rounded-md group gap-x-3 text-sm/6 text-emerald-100 hover:text-white hover:bg-emerald-800">
                        <svg class="size-6 shrink-0 text-emerald-300 group-hover:text-white" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M9 6.75V15m6-6v8.25m.503 3.498l4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.25c-.836-.417-1.873-.417-2.709 0L3.372 4.82c-.836.417-.88 1.38-.128 1.847l3.848 2.437c.317.2.69.2 1.006 0l4.125-2.063c.836-.417 1.873-.417 2.709 0L21 6.75" />
                        </svg>
                        Map
                    </a>
                </li>
