    ...
    <nav class="flex items-center justify-between p-6 mx-auto max-w-7xl lg:px-8" aria-label="Global">
        {{-- <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
                ...
                <img class="w-auto h-8" src="/assets/images/LogoSobatBumi.png" alt="" />
            </a>
        </div>
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            <div class="relative">
                <button type="button" id="product-menu-toggle"
                    class="flex items-center font-semibold text-gray-900 gap-x-1 text-sm/6" aria-expanded="false">
                    Product
                    <svg class="flex-none text-gray-400 transition-transform duration-200 size-5" viewBox="0 0 20 20"
                ...
                <!-- Product flyout menu -->
                <div id="product-menu"
                    class="absolute z-10 w-screen max-w-md mt-3 overflow-hidden transition-all duration-200 ease-out -translate-x-1/2 translate-y-1 bg-white shadow-lg opacity-0 pointer-events-none left-1/2 rounded-3xl ring-1 ring-gray-900/5">
                    <div class="p-4">
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
            <a href="#" class="font-semibold text-gray-900 text-sm/6">Log in <span
                    aria-hidden="true">&rarr;</span></a>
        </div>
    </nav>

    <!-- Mobile menu -->
    <div id="mobile-menu" class="fixed inset-0 z-50 hidden lg:hidden" role="dialog" aria-modal="true">
        <!-- Background backdrop -->
                    ...
                    <div class="py-6 space-y-2">
                        <div class="-mx-3">
                            <button type="button" id="mobile-product-toggle"
                                ...
                                aria-controls="mobile-products" aria-expanded="false">
                                Product
                                <svg class="flex-none transition-transform duration-200 size-5" viewBox="0 0 20 20"
                                    fill="currentColor" aria-hidden="true" data-slot="icon">
                                    <path fill-rule="evenodd"
                                        d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z"
                                        clip-rule="evenodd" />
                            ...
                            <div class="hidden mt-2 space-y-2" id="mobile-products">
                                <a href="#"
                        ...
                        <a href="#"
                            class="block px-3 py-2 -mx-3 font-semibold text-gray-900 rounded-lg text-base/7 hover:bg-gray-50">Features</a>
                        <a href="#"
                            class="block px-3 py-2 -mx-3 font-semibold text-gray-900 rounded-lg text-base/7 hover:bg-gray-50">Marketplace</a>
                        <a href="#"
                            class="block px-3 py-2 -mx-3 font-semibold text-gray-900 rounded-lg text-base/7 hover:bg-gray-50">Company</a>
                    </div>
                    <div class="py-6">
                        <a href="#"
