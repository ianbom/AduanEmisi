...
<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-green-500 to-blue-600 px-6 py-4">
            <h2 class="text-2xl font-bold text-white">Edit Badge</h2>
            <p class="text-black mt-1">Perbarui informasi badge</p>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.badges.update', $badge->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    placeholder="Masukkan judul badge"
                    required
                >
                @error('title')
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    placeholder="Masukkan deskripsi badge (opsional)"
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center space-x-4">
                        <img src="{{ asset('storage/' . $badge->icon_url) }}" alt="Current Badge Icon" class="w-16 h-16 object-cover rounded-lg border">
                        <div>
                            <p class="text-sm font-medium">{{ basename($badge->icon_url) }}</p>
                ...
                <div class="flex items-center justify-center w-full">
                    <label for="icon_url" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors @error('icon_url') border-red-500 @enderror">
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                <a href="{{ route('admin.badges.index') }}" class="px-6 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors">
                    Batal
                </a>
