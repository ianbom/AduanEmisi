    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
       ...
       @include('admin.components.notification')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            ...
            <form action="{{ route('admin.merchandise.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg hover:border-gray-400 transition-colors duration-200 @error('image_url') border-red-300 @enderror">
                        <div class="space-y-1 text-center">
                            <div id="image-preview" class="hidden mb-4">
                                <img id="preview-img" src="#" alt="Preview" class="mx-auto h-32 w-32 object-cover rounded-lg border border-gray-200">
                            </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <span class="absolute right-3 top-3 text-gray-500 text-sm">poin</span>
                    </div>
                    @error('points_cost')
                    <p class="text-sm text-red-600 flex items-center mt-1">
                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-xs text-gray-500">Merchandise yang tidak aktif tidak akan ditampilkan kepada pengguna</p>
                </div>
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit"
                            class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors duration-200 flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
