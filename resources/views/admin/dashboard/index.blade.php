...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-500 hover:shadow-lg transition-shadow cursor-pointer" onclick="window.location.href='/admin/reports?status=pending'">
            ...
            <!-- Misi Aktif -->
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500 hover:shadow-lg transition-shadow cursor-pointer" onclick="window.location.href='/admin/missions'">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                        ...
                        @forelse($pendingReports as $report)
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-600">{{ $report->reporter->name }} • {{ $report->city->name }} • {{ $report->created_at->diffForHumans() }}</p>
                                </div>
                                <a href="{{ route('admin.reports.show', $report->id) }}" class="px-3 py-1 bg-yellow-600 text-white text-sm rounded-md hover:bg-yellow-700 transition-colors">
                                    Pending
                                </a>
                            </div>
                        @empty
                            <p class="text-center text-gray-500 py-4">Tidak ada laporan yang perlu diverifikasi saat ini.</p>
                        @endforelse
                    </div>
                    <div class="mt-4 text-center">
                        <a href="{{ route('admin.reports.index', ['status' => 'pending']) }}" class="text-red-600 hover:text-red-700 font-medium">
                            Lihat Semua Laporan →
                        </a>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-md">
                ...
                <div class="p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600">{{ $community->user->city->name ?? 'Belum melengkapi profile' }} • {{ $community->member_count}} Anggota </p>
                            </div>
                            <button class="px-3 py-1 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700 transition-colors">
                                Lihat
                            </button>
                        </div>
                    </div>
                    @endforeach
                    <div class="mt-4 text-center">
                        <a href="/admin/communities?status=pending" class="text-blue-600 hover:text-blue-700 font-medium">
            ...
            <div class="p-6">
                <div id="map" class="w-full h-96 bg-gray-100 rounded-lg flex items-center justify-center">
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-500 mt-2">Integrasi dengan Leaflet.js atau Google Maps API</p>
                    </div>
                </div>
            </div>
        </div>

        <!-- Bagian 4: Aktivitas Terkini -->
        <div class="bg-white rounded-lg shadow-md">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-xl font-semibold text-gray-900">Aktivitas Terkini</h2>
                <p class="text-sm text-gray-600">Log aktivitas platform real-time</p>
            </div>
            <div class="p-6">
                <div class="space-y-4 max-h-96 overflow-y-auto">
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-900">
                                <span class="font-medium">Ahmad Budi</span> baru saja mendaftar
                            </p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-900">
                                Misi <span class="font-medium">'Bersih-bersih Pantai Ancol'</span> telah selesai
                            </p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-900">
                                Komunitas <span class="font-medium">Peduli Sungai</span> mendapatkan lencana 'Pahlawan Air'
                            </p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-900">
                                Donasi sebesar <span class="font-medium">Rp 100.000</span> diterima untuk laporan 'Tumpukan Sampah di Ciliwung'
                            </p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-900">
                                Laporan baru: <span class="font-medium">'Pencemaran Air di Kali Malang'</span> oleh Siti Rahayu
                            </p>
                            <p class="text-xs text-gray-500">1 jam lalu</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-900">
                                <span class="font-medium">Eko Prasetyo</span> bergabung dengan komunitas 'Green Warriors'
                            </p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-900">
                                Misi baru: <span class="font-medium">'Tanam 1000 Pohon di Depok'</span> telah dibuat
                            </p>
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-gray-900">
                                Donasi sebesar <span class="font-medium">Rp 500.000</span> diterima untuk misi 'Restorasi Mangrove'
                            </p>
                ...
                <div class="mt-4 text-center">
                    <a href="/admin/activity-log" class="text-gray-600 hover:text-gray-700 font-medium">
            ...
            mapData.forEach(report => {
                if (report.latitude && report.longitude) {
                    L.marker([report.latitude, report.longitude]).addTo(map)
                        .bindPopup(`<b>${report.title}</b><br><a href="/admin/reports/${report.id}" target="_blank">Lihat detail</a>`);
                }
            });
        } else {
             mapContainer.innerHTML = '<div class="text-center p-4"><p class="text-gray-500">Tidak ada data lokasi laporan untuk ditampilkan.</p></div>';
        }
    }
